...
drive_download(
      ...
      path = "./data/raw_data/2020-05-26/Correctional_Facility_Hort_Programs_Becca.xlsx",
      overwrite = TRUE)
...
drive_download(
  ...
  path = "./data/raw_data/2020-05-26/Correctional_Facility_Contact_Tracking_Addy_States_SUMMER.xlsx",
  overwrite = TRUE)
...
drive_download(
  ...
  path = "./data/raw_data/2020-05-26/Correctional_Facility_Contact_Tracking_Josh_States_NEWEST.xlsx",
  overwrite = TRUE)
...
drive_download(
  ...
  path = "./data/raw_data/2020-05-26/Correctional_Facility_Contact_Tracking_Carrie_States.xlsx",
  overwrite = TRUE)

#No longer importing Azmal's spreadsheets: all facilities in it covered by Carrie's and Becca's spreadsheet
...
drive_download(
  ...
  path = "./data/raw_data/2020-05-26/Correctional_Facility_Contact_Tracking_Evan_States_SUMMER.xlsx",
  overwrite = TRUE)

rm(addy, becca, carrie, evan, josh)

###########ARCHIVE: February 16, 2020 Import###########

#Import Becca's spreadsheets
#becca <- drive_get(as_id("https://docs.google.com/spreadsheets/d/1Z3bVdLkiYJFrm4UA4lZwftrOLqdRhd0-/"))
#drive_download(
#      file = as_id("https://docs.google.com/spreadsheets/d/1Z3bVdLkiYJFrm4UA4lZwftrOLqdRhd0-/"), 
#      path = "./data/raw_data/2020-02-16/Correctional_Facility_Ag_Hort_Garden_Becca_States_SUMMER.xlsx",
#      overwrite = TRUE)
...
#drive_download(
#  file = as_id("https://docs.google.com/spreadsheets/d/1dHcloCb0dnGWNJJujC6ZcomXOcL88HKc"), 
#  path = "./data/raw_data/2020-02-16/Correctional_Facility_Contact_Tracking_Addy_States_SUMMER.xlsx",
#  overwrite = TRUE)
...
#drive_download(
#  file = as_id("https://docs.google.com/spreadsheets/d/1pVtJQkMAeilikn-tXe-zT4_NnaujyaXh"), 
#  path = "./data/raw_data/2020-02-16/Correctional_Facility_Contact_Tracking_Josh_States_SUMMER.xlsx",
#  overwrite = TRUE)
...
#drive_download(
#  file = as_id("https://docs.google.com/spreadsheets/d/1xFcgV5AbYpa7LFnanFMSU18KCRUwAvCsaQyx1zUkpio"),
#  path = "./data/raw_data/2020-02-16/Correctional_Facility_Contact_Tracking_Carrie_States.xlsx",
#  overwrite = TRUE)
...
#  path = "./data/raw_data/2020-02-16/Correctional_Facility_Contact_Tracking_Azmal_States_SUMMER.xlsx",
#  overwrite = TRUE)
...
#drive_download(
#  file = as_id("https://docs.google.com/spreadsheets/d/1CsM5fbXbmm09f9GPhrTPW7NoCCQIlE2B"),
#  path = "./data/raw_data/2020-02-16/Correctional_Facility_Contact_Tracking_Evan_States_SUMMER.xlsx",
#  overwrite = TRUE)
