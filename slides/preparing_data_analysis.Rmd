...
- Our lab group has decided what values to record in the column "Confirmed Programs": 1 = confirmed that program(s) are at that facility, 0 = confirmed that *no* programs are at that facility, null (empty) = unconfirmed/yet to confirm
